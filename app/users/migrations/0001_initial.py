# Generated by Django 3.0.3 on 2020-05-12 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Wait', 'Wait'), ('Block', 'Block'), ('New_Accept', 'New_Accept'), ('Accept', 'Accept')], default='Wait', max_length=35)),
            ],
        ),
        migrations.CreateModel(
