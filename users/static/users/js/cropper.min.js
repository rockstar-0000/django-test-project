...
!function (t, e) {
    ...
    function p(t, e) {
        var a = Math.abs(t.degree) % 180, i = (a > 90 ? 180 - a : a) * Math.PI / 180, o = Math.sin(i), n = Math.cos(i),
            r = t.width, h = t.height, s = t.aspectRatio, d = void 0, c = void 0;
        return e ? (d = r / (n + o / s), c = d / s) : (d = r * n + h * o, c = r * o + h * n), {width: d, height: c}
    }

    function l(a, i) {
        var o = t("<canvas>")[0], n = o.getContext("2d"), r = 0, h = 0, s = i.naturalWidth, d = i.naturalHeight,
            c = i.rotate, l = i.scaleX, f = i.scaleY, g = e(l) && e(f) && (1 !== l || 1 !== f), m = e(c) && 0 !== c,
            u = m || g, v = s * Math.abs(l || 1), x = d * Math.abs(f || 1), w = void 0, b = void 0, y = void 0;
    ...
    function g(t) {
        var e = new DataView(t), a = e.byteLength, i = void 0, o = void 0, n = void 0, r = void 0, h = void 0,
            s = void 0, d = void 0, c = void 0, p = void 0, l = void 0;
        ...
        if (d && (o = d + 4, n = d + 10, "Exif" === f(e, o, 4) && (s = e.getUint16(n), h = 18761 === s, (h || 19789 === s) && 42 === e.getUint16(n + 2, h) && (r = e.getUint32(n + 4, h), r >= 8 && (c = n + r)))), c) for (a = e.getUint16(c, h), l = 0; l < a; l++) if (p = c + 12 * l + 2, 274 === e.getUint16(p, h)) {
    ...
    function x(e) {
        ...
        return t.each(e, function (e, o) {
            delete a[e], t.each(a, function (t, e) {
                var a = Math.abs(o.startX - e.startX), n = Math.abs(o.startY - e.startY), r = Math.abs(o.endX - e.endX),
                    h = Math.abs(o.endY - e.endY), s = Math.sqrt(a * a + n * n), d = Math.sqrt(r * r + h * h),
                    c = (d - s) / s;
                i.push(c)
            })
        }), i.sort(function (t, e) {
    ...
    var b = {
        ...
        C = /^data:.*,/, M = /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i,
        $ = "undefined" != typeof window ? window.navigator : null, B = $ && M.test($.userAgent),
        k = String.fromCharCode, D = {
            render: function () {
                ...
                var e = this, a = e.options.viewMode, i = e.container, o = i.width, n = i.height, r = e.image,
                    h = r.naturalWidth, s = r.naturalHeight, d = 90 === Math.abs(r.rotate), c = d ? s : h, p = d ? h : s,
                    l = c / p, f = o, g = n;
                ...
                var a = this, i = a.options, o = i.viewMode, n = a.container, r = n.width, h = n.height, s = a.canvas,
                    d = s.aspectRatio, c = a.cropBox, p = a.cropped && c;
                if (t) {
                    var l = Number(i.minCanvasWidth) || 0, f = Number(i.minCanvasHeight) || 0;
                ...
                var e = this, a = e.canvas, i = e.image, o = i.rotate, n = i.naturalWidth, r = i.naturalHeight;
                if (e.rotated) {
                    e.rotated = !1;
                    var h = p({width: i.width, height: i.height, degree: o}), s = h.width / h.height,
                        d = 1 === i.aspectRatio;
                ...
                var e = this, a = e.options, i = e.canvas, o = a.aspectRatio, n = Number(a.autoCropArea) || .8,
                ...
                var a = this, i = a.options, o = i.aspectRatio, n = a.container, r = n.width, h = n.height, s = a.canvas,
                    d = a.cropBox, c = a.limited;
                if (t) {
                    var p = Number(i.minCropBoxWidth) || 0, l = Number(i.minCropBoxHeight) || 0,
                        f = Math.min(r, c ? s.width : r), g = Math.min(h, c ? s.height : h);
            ...
            initPreview: function () {
                ...
                var e = this, a = e.image, i = e.canvas, o = e.cropBox, n = o.width, r = o.height, h = a.width,
                    s = a.height, d = o.left - i.left - a.left, p = o.top - i.top - a.top;
                e.cropped && !e.disabled && (e.$clone2.css({
                    width: h,
                    height: s,
                    transform: c(t.extend({translateX: -d, translateY: -p}, a))
                }), e.$preview.each(function (e, i) {
                    var o = t(i), l = o.data(T), f = l.width, g = l.height, m = f, u = g, v = 1;
        ...
        }, Y = "undefined" != typeof window ? window.PointerEvent : null, W = Y ? "pointerdown" : "touchstart mousedown",
        H = Y ? "pointermove" : "touchmove mousemove",
        z = Y ? " pointerup pointercancel" : "touchend touchcancel mouseup", O = "wheel mousewheel DOMMouseScroll",
        R = "dblclick", L = "resize", N = "cropstart", I = "cropmove", P = "cropend", E = "crop", U = "zoom", A = {
            bind: function () {
            ...
            change: function (e) {
                var a = this, i = a.options, o = a.pointers, r = o[n(o)[0]], h = a.container, s = a.canvas, d = a.cropBox,
                    c = a.action, p = i.aspectRatio, l = d.width, f = d.height, g = d.left, m = d.top, u = g + l, v = m + f,
                    w = 0, b = 0, y = h.width, C = h.height, M = !0, $ = void 0;
            ...
            crop: function () {
                ...
                var a = this, i = a.options, o = a.pointers, r = a.canvas, h = r.width, s = r.height, d = r.naturalWidth,
                    c = r.naturalHeight;
                if (t = Number(t), t >= 0 && a.ready && !a.disabled && i.zoomable) {
                    var p = d * t, l = c * t, f = void 0;
                ...
                var c = Math.floor(h || o), p = Math.floor(s || n), f = t("<canvas>")[0], g = f.getContext("2d");
                f.width = c, f.height = p, e.fillColor && (g.fillStyle = e.fillColor, g.fillRect(0, 0, c, p));
                var m = function () {
                    var t = l(a.$clone[0], a.image), e = t.width, r = t.height, h = a.canvas, s = [t],
                        c = i.x + h.naturalWidth * (Math.abs(i.scaleX || 1) - 1) / 2,
                        p = i.y + h.naturalHeight * (Math.abs(i.scaleY || 1) - 1) / 2, f = void 0, g = void 0, m = void 0,
                        u = void 0, v = void 0, x = void 0;
            ...
            return et(e, [{
                ...
                key: "read", value: function (t) {
                    var e = this, a = e.options, i = g(t), o = e.image, n = 0, r = 1, h = 1;
