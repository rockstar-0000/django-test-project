...
urlpatterns = [
    ...
    path('messages/<str:conversation_id>/', views.conversation_messages, name='conversation-messages'),
    path('message/send/<str:conversation_id>/', views.create_message, name='create-message'),
]