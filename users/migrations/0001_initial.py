# Generated by Django 3.0.3 on 2020-05-13 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('Block', 'Block'), ('New_Accept', 'New_Accept'), ('Wait', 'Wait'), ('Accept', 'Accept')], default='Wait', max_length=35)),
            ],
        ),
        migrations.CreateModel(
